...
- Explain DAA connection
- Highlight key innovations
- Mention performance improvements
```

#### 2. **Algorithmic Choices (5-7 minutes)**
```
"Why did you choose these algorithms?"
- Explain complexity classes represented
- Discuss practical vs theoretical performance
- Justify algorithm selection criteria
- Demonstrate understanding of trade-offs
```

#### 3. **Implementation Challenges (3-4 minutes)**
```
"What were the main challenges?"
- Multi-threading with JavaFX
- Memory management for large file sets
- UI responsiveness during processing
- Algorithm correctness verification
```

#### 4. **Performance Analysis (4-5 minutes)**
```
...
#### 5. **Educational Impact (2-3 minutes)**
```
"What did you learn from this project?"
- DAA principle application
- Algorithm implementation skills
- Performance analysis techniques
- Software architecture patterns
```

### 🗣️ Expected Viva Questions

#### Basic Understanding
- "What is the difference between O(n) and O(n²)?"
- "Why is hashing better than pairwise comparison for duplicates?"
- "Explain the classification pipeline stages."

#### Technical Depth
- "Why did you choose SHA-256 over MD5?"
- "How does the confidence threshold work?"
- "Explain the size pre-grouping optimization."

#### Design Decisions
- "Why JavaFX over Swing?"
- "Why MVC architecture?"
- "Why Maven for build management?"

#### Performance Questions
- "What is the actual performance improvement?"
...
- **Know Your Code**: Be able to explain any part of implementation
- **Understand Trade-offs**: Explain why you made specific choices
- **Have Benchmarks Ready**: Be prepared to discuss performance numbers
- **Practice Explanations**: Explain concepts in simple terms

#### Common Pitfalls to Avoid
- ❌ Don't memorize answers - understand concepts
- ❌ Don't focus only on features - emphasize algorithms
- ❌ Don't ignore UI aspects - explain technical decisions
- ❌ Don't skip performance questions - have data ready
